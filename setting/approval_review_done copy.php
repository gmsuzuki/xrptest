    ...
    <main id="main">
      ...
      <div class="approval_review_wrap">
        ...
        <form action="" class="reserve_button_wrap">
          ...
          <a href='reserve_mail.php?selected_reserve_num=<?php echo urlencode($review_card->getReservationNumber()) ?>'
            class="reserve_back mail_to">お客様へ連絡</a>


          <!-- <a href="reserve_schedule.php" class="reserve_back">お客様へ連絡</a> -->
          <input type="submit" id="nextButtonq" name="confirmq" class="done" value="確定">
